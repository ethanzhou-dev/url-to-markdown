...
- **智能提取**：基于 Readability 算法，识别网页文章的主体内容。
- **纯净 Markdown**：将网页 DOM 结构转换为 Markdown 语法。
- **轻量安全**：基于 Manifest V3 规范开发，完全在本地处理，保护隐私。
...
3. 在页面右上角（或左下角）打开 **“开发者模式”** 。
4. 点击左上角的 **“加载已解压的扩展程序”** 按钮。
5. 选择本项目的文件夹。
6. 安装成功，您可以在浏览器右上角的扩展栏中看到它的图标。
